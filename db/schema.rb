...
ActiveRecord::Schema.define(version: 2019_01_31_134753) do
  ...
  create_table "diploms", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_diploms_on_doctor_id"
    t.index ["specialty_id"], name: "index_diploms_on_specialty_id"
  end
